...
export const Route = createFileRoute("/politicas-legales")({
  head: () => ({
    meta: buildSeo({
      ...
      description:
        "Política de Privacidad, Tratamiento de Datos Personales, Términos y Condiciones, Cookies y Disclaimers de G-Structure y KAIRON, bajo legislación ecuatoriana.",
    }),
...
const TOC: { id: string; label: string }[] = [
  ...
  { id: "kairon", label: "20. Disclaimer KAIRON" },
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="container-x relative py-16 md:py-24">
          ...
          <h1 className="mt-6 max-w-3xl font-display text-3xl md:text-5xl leading-[1.05]">
            Políticas legales de G-Structure y KAIRON
          </h1>
          <p className="mt-6 max-w-3xl text-base md:text-lg text-muted-foreground leading-relaxed">
            ...
            condiciones de uso de los servicios digitales de G-Structure y KAIRON.
          </p>
          ...
          <article className="lg:col-span-8 space-y-14 text-[15px] leading-relaxed text-foreground/90">
            ...
            <Block id="datos" title="3. Datos personales que podemos recopilar">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Datos ingresados al interactuar con KAIRON, incluyendo el MVP activo y versiones posteriores.</li>
              </ul>
            </Block>
            ...
            <Block id="finalidades" title="5. Finalidades del tratamiento">
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Gestionar la lista de espera de KAIRON.</li>
            ...
            <Block id="propiedad" title="18. Propiedad intelectual">
              <p>
                ...
                G-Structure, KAIRON y REESTRUCTURA— son propiedad de su titular o se usan con
                autorización.
              </p>
              <p>
            ...
            <Block id="kairon" title="20. KAIRON no es una herramienta clínica">
              <div className="border-l-4 border-amber-500 bg-amber-50/40 dark:bg-amber-950/10 p-4 space-y-3">
                <p>
                  KAIRON es una herramienta digital de coaching cognitivo con IA en MVP activo,
                  con fines educativos, formativos y de ejecución personal/profesional. Sus ejercicios, registros, métricas, indicadores o
