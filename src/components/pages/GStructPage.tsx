...
const COPY: Record<Locale, Copy> = {
  es: {
    hero: {
      eyebrow: "PRODUCTO PRINCIPAL DE G-STRUCTURE · PROTOTIPO ACTIVO · LANZAMIENTO Q3 2026",
      h1: "G-Struct: la plataforma cognitivo-conductual de G-Structure.",
      leadA: "Diagnostica, reencuadra y optimiza tu ejecución",
      leadB: "con metodología CBT coaching aplicada.",
      body: "G-Struct identifica la fricción cognitivo-conductual que bloquea tu ejecución, te ayuda a reencuadrarla con metodología CBT coaching, y optimiza tu acción. No para que te sientas mejor — para que ejecutes mejor.",
    ...
    engine: {
      eyebrow: "EL MOTOR DE REESTRUCTURACIÓN",
      h2: "Si puedes medirlo, puedes optimizarlo.",
    ...
    note: {
      ...
      body: "G-Struct es una herramienta de coaching de ejecución, no una aplicación clínica. No diagnostica, no trata y no reemplaza la psicoterapia, la psicología clínica ni la psiquiatría. Aplica metodología CBT coaching — el mismo framework utilizado por coaches ejecutivos a nivel global — para ayudarte a identificar y reencuadrar los patrones cognitivos que bloquean tu ejecución.",
    },
  ...
  en: {
    hero: {
      eyebrow: "G-STRUCTURE'S MAIN PRODUCT · ACTIVE PROTOTYPE · LAUNCH Q3 2026",
      h1: "G-Struct: G-Structure's cognitive-behavioral platform.",
      leadA: "Diagnose, reframe and optimize your execution",
      leadB: "with applied CBT coaching methodology.",
      body: "G-Struct identifies the cognitive-behavioral friction blocking your execution, helps you reframe it with CBT coaching methodology, and optimizes your action. Not to make you feel better — to make you execute better.",
    ...
    engine: {
      eyebrow: "THE RESTRUCTURING ENGINE",
      h2: "If you can measure it, you can optimize it.",
    ...
    note: {
      ...
      body: "G-Struct is an execution-coaching tool, not a clinical application. It does not diagnose, does not treat and does not replace psychotherapy, clinical psychology or psychiatry. It applies CBT coaching methodology — the same framework used by executive coaches globally — to help you identify and reframe the cognitive patterns blocking your execution.",
    },
