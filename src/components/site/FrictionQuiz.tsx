...
const RESULTS_ES: Record<Letter, { label: string; title: string; body: string }> = {
  A: {
    ...
    body: "No es pereza. Es un mecanismo de protección cognitiva: posponer reduce la ansiedad a corto plazo — y bloquea la ejecución a largo plazo. El Motor de Reestructuración de KAIRON está diseñado específicamente para este patrón.",
  },
  B: {
    label: "PERFECCIONISMO IMPRODUCTIVO",
    title: "Tu patrón principal es el perfeccionismo improductivo.",
    body: "El estándar elevado no es el problema — el problema es cuando ese estándar se convierte en una excusa elegante para no entregar. KAIRON te ayuda a distinguir entre criterio y evitación.",
  },
  C: {
    label: "SOBREANÁLISIS",
  ...
  D: {
    ...
    body: "No es falta de capacidad — es una lectura distorsionada de tu propia evidencia. El 75% de los high-performers en LATAM lo experimentan. KAIRON trabaja directamente sobre este patrón con metodología CBT coaching.",
  },
};
...
const RESULTS_EN: Record<Letter, { label: string; title: string; body: string }> = {
  A: {
    ...
    body: "It's not laziness. It's a cognitive protection mechanism: postponing reduces anxiety short-term — and blocks execution long-term. KAIRON's Restructuring Engine is designed specifically for this pattern.",
  },
  B: {
    label: "UNPRODUCTIVE PERFECTIONISM",
    title: "Your main pattern is unproductive perfectionism.",
    body: "A high standard isn't the problem — the problem is when that standard becomes an elegant excuse not to ship. KAIRON helps you distinguish criterion from avoidance.",
  },
  C: {
    label: "OVERTHINKING",
  ...
  D: {
    ...
    body: "It's not lack of capacity — it's a distorted reading of your own evidence. 75% of high-performers in LATAM experience it. KAIRON works directly on this pattern with CBT coaching methodology.",
  },
};
...
const UI_COPY = {
  es: {
    ...
    sub: "Este diagnóstico breve te ayuda a reconocer si tu bloqueo está más relacionado con procrastinación, perfeccionismo, sobreanálisis, evitación, saturación mental o autosabotaje. Al finalizar, podrás unirte a la lista de espera de KAIRON y recibir acceso temprano a la plataforma.",
  ...
  en: {
    ...
    sub: "This short diagnostic helps you recognize whether your block is more related to procrastination, perfectionism, overthinking, avoidance, mental saturation, or self-sabotage. When you finish, you can join the KAIRON waitlist and get early access to the platform.",
