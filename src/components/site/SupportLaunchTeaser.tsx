...
export function SupportLaunchTeaser() {
  ...
  const copy = locale === "en"
    ? {
        ...
        subtitle:
          "Help G-Structure move KAIRON from prototype to MVP through early validation, product development, and the July 14 launch inside Ecuador Tech Week.",
        note:
    ...
    : {
        ...
        subtitle:
          "Ayuda a G-Structure a llevar KAIRON del prototipo al MVP mediante validación temprana, desarrollo de producto y el lanzamiento del 14 de julio dentro de Ecuador Tech Week.",
        note:
