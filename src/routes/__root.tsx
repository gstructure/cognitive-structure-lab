...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "G-Structure | KAIRON, método I-R-O y ejecución profesional" },
      {
        name: "description",
        content:
          "G-Structure es una tech startup construyendo KAIRON, un Cognitive OS para ejecución guiado por Kai e impulsado por el método I-R-O.",
      },
      { name: "author", content: "G-Structure" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "G-Structure | KAIRON, método I-R-O y ejecución profesional" },
      { name: "twitter:title", content: "G-Structure | KAIRON, método I-R-O y ejecución profesional" },
      { property: "og:description", content: "G-Structure es una tech startup construyendo KAIRON, un Cognitive OS para ejecución guiado por Kai e impulsado por el método I-R-O." },
      { name: "twitter:description", content: "G-Structure es una tech startup construyendo KAIRON, un Cognitive OS para ejecución guiado por Kai e impulsado por el método I-R-O." },
