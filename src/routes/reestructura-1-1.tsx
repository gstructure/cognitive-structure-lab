...
export const Route = createFileRoute("/reestructura-1-1")({
  head: () => ({
    meta: buildSeo({
      ...
      description:
        "Canal individual de validación de G-Structure para aplicar el método I-R-O con profesionales, líderes y emprendedores mientras alimenta el desarrollo de KAIRON.",
