...
export const Route = createFileRoute("/en/restructure-1-1")({
  head: () => ({
    meta: buildSeo({
      ...
      description:
        "G-Structure's individual validation channel for applying the I-R-O Method with professionals, leaders, and entrepreneurs while feeding the development of KAIRON.",
      locale: "en_US",
    }),
