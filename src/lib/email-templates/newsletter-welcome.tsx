...
const Email = ({ locale = "es" }: { locale?: "es" | "en" }) => {
  const copy = locale === "en"
    ? {
        ...
        title: "You are in.",
        intro:
          "Thanks for subscribing to G-Structure notes. This is where we share essays, product updates, and the thinking behind KAIRON.",
        promise:
          "Expect useful notes on the I-R-O™ Method, cognitive-behavioral execution, and what we are learning while building KAIRON for Q3.",
        cadence:
    ...
    : {
        ...
        title: "Estás dentro.",
        intro:
          "Gracias por suscribirte a las notas de G-Structure. Aquí compartimos artículos, updates del producto y el pensamiento detrás de KAIRON.",
        promise:
          "Vas a recibir notas útiles sobre el Método I-R-O™, ejecución cognitivo-conductual y lo que estamos aprendiendo mientras construimos KAIRON para Q3.",
        cadence:
