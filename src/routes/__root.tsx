...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "G-Structure | G-Frame, método I-R-O y ejecución profesional" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "G-Structure | G-Frame, método I-R-O y ejecución profesional" },
      { name: "twitter:title", content: "G-Structure | G-Frame, método I-R-O y ejecución profesional" },
      { property: "og:description", content: "G-Structure es una tech startup construyendo G-Frame, una plataforma cognitivo-conductual de ejecución profesional impulsada por el método I-R-O." },
      { name: "twitter:description", content: "G-Structure es una tech startup construyendo G-Frame, una plataforma cognitivo-conductual de ejecución profesional impulsada por el método I-R-O." },
