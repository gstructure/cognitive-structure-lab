...
export type ArticleCategory = "Founder Notes" | "KAIRON Build Notes" | "I-R-O™ Method" | "Company Updates";
...
export const ARTICLES: Article[] = [
  {
    ...
    title: "G-Structure avanza como semifinalista de CodeLaunch LATAM 2026",
    subtitle: "Una nueva señal de tracción para G-Structure y KAIRON desde Ecuador.",
    category: "Company Updates",
    excerpt:
      "G-Structure es semifinalista de CodeLaunch LATAM 2026. Esperamos saber si seremos seleccionados para competir en las finales de Guadalajara; si ganamos esa etapa, podríamos avanzar al World Championship en Dallas.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-27",
    readMinutes: 4,
    featured: true,
    tags: ["G-Structure", "CodeLaunch LATAM 2026", "KAIRON", "Startup"],
    blocks: [
      { type: "p", text: "Hoy recibimos una noticia enorme para G-Structure: avanzamos como semifinalistas de CodeLaunch LATAM 2026." },
      ...
      { type: "p", text: "Ese producto es KAIRON. Los programas 1:1, Enterprise, el Workshop de Diagnóstico de Ejecución y el apoyo temprano no son negocios separados; son canales para validar el método I-R-O™, aprender con usuarios reales, generar revenue temprano y preparar el camino hacia un producto digital escalable." },
      { type: "p", text: "Estar en esta etapa de CodeLaunch LATAM nos obliga a seguir ordenando la casa: producto, narrativa, validación, equipo, evidencia y tracción. Ahora esperamos saber si seremos seleccionados para competir en las finales regionales en Guadalajara, México, el 14 de octubre de 2026. Si ganamos esa etapa, podríamos avanzar al World Championship en Dallas, Texas, el 12 de noviembre de 2026." },
      { type: "quote", text: "G-Structure está construyendo KAIRON desde Ecuador, con una ambición regional y una tesis clara sobre la ejecución humana." },
      { type: "p", text: "Antes de llegar allá, tenemos trabajo por hacer. Seguir desarrollando el prototipo, fortalecer la validación con usuarios, preparar el lanzamiento dentro de Ecuador Tech Week 2026 y demostrar que KAIRON puede intervenir una brecha real: la distancia entre saber qué hacer y lograr ejecutarlo." },
      { type: "p", text: "Esta noticia no cambia la dirección. La confirma. G-Structure sigue siendo la startup. KAIRON sigue siendo el producto principal. I-R-O™ sigue siendo el método que sostiene la construcción. Y ahora tenemos una nueva plataforma para llevar esa visión más lejos." },
  ...
  },
  {
    ...
    subtitle: "Nuestra marca sigue siendo G-Structure. Nuestro producto principal sigue siendo KAIRON. SUCOSTRUCT S.A.S. B.I.C. es la razón social que sostiene la siguiente etapa.",
    category: "Company Updates",
    excerpt:
      "G-Structure ahora cuenta con una estructura legal constituida en Ecuador como SUCOSTRUCT S.A.S. B.I.C., un paso para operar, validar y escalar KAIRON con mayor claridad.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-21",
    readMinutes: 4,
    featured: true,
    tags: ["G-Structure", "SUCOSTRUCT", "Company Update", "KAIRON"],
    blocks: [
      ...
      { type: "p", text: "Esta estructura nos permite organizar mejor nuestras operaciones, abrir conversaciones corporativas con mayor solidez, preparar el desarrollo de KAIRON como plataforma digital y construir relaciones comerciales, institucionales y estratégicas desde una figura jurídica adecuada." },
      { type: "p", text: "KAIRON sigue siendo una prioridad central. Esta constitución nos da una base más sólida para seguir trabajando en su desarrollo, validación y escalamiento. No estamos hablando solo de una app. Estamos construyendo una herramienta para ayudar a las personas a procesar su fricción mental, entender sus patrones de ejecución y convertir claridad en acción." },
      ...
      { type: "p", text: "Este paso confirma algo importante: estamos construyendo la estructura necesaria para sostener nuestra visión. Queremos consolidar a G-Structure como una startup líder en la región en optimización de la ejecución profesional, convirtiendo nuestro método propietario I-R-O™ en un estándar digital de desarrollo cognitivo-conductual a través del escalamiento de KAIRON." },
      { type: "p", text: "G-Structure sigue siendo G-Structure. KAIRON sigue siendo el producto principal. Ahora operamos desde una estructura legal más clara: SUCOSTRUCT S.A.S. B.I.C." },
      { type: "p", text: "Y seguimos avanzando." },
    ],
  },
  {
    slug: "g-frame-product-update-q3",
    title: "KAIRON Product Update: lo que estamos construyendo para Q3",
    category: "KAIRON Build Notes",
    excerpt:
      "Una mirada al prototipo de KAIRON, la lógica I-R-O™ que lo sostiene y lo que estamos validando antes del lanzamiento Q3.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-19",
    readMinutes: 8,
    featured: true,
    tags: ["KAIRON", "Product Update", "Q3", "Execution"],
    blocks: [
      { type: "p", text: "Hay una pregunta que nos ha acompañado desde el inicio de KAIRON: ¿qué pasaría si una app no solo ayudara a organizar tareas, sino a entender el patrón mental que impide ejecutarlas?" },
      { type: "p", text: "Esa pregunta sigue guiando el producto. No estamos construyendo otra app de productividad. Tampoco una app de journaling, seguimiento emocional o motivación diaria. KAIRON nace de una premisa distinta: muchas personas no se bloquean porque no sepan qué tienen que hacer, sino porque el costo mental de hacerlo se vuelve demasiado alto." },
      ...
      { type: "p", text: "Esa es la tesis central detrás de KAIRON. La ejecución no es solo gestión del tiempo. También es interpretación, emoción, creencia y respuesta conductual. Una persona puede tener una agenda ordenada, una lista de tareas clara y una meta importante frente a sí, pero si su sistema interno interpreta la acción como amenaza, juicio, riesgo o insuficiencia, la organización por sí sola no alcanza." },
      { type: "p", text: "Por eso KAIRON se está construyendo como un sistema de coaching cognitivo-conductual aplicado a la ejecución. Su objetivo no es decirle al usuario simplemente “haz más” o “organízate mejor”. El objetivo es ayudarle a identificar qué está pasando internamente, reencuadrarlo con método y convertir esa nueva lectura en una acción pequeña, concreta y ejecutable." },
      ...
      { type: "p", text: "Sobre esta estructura estamos integrando una capa de IA: Guillermo, el coach virtual de KAIRON. Esta parte requiere especial cuidado. La IA no puede ser una decoración del producto ni una voz genérica que entrega frases correctas pero vacías. Tiene que entender el método, respetar límites de seguridad, usar un lenguaje claro y ayudar al usuario a pasar de pensamiento a acción. Tampoco puede presentarse como terapeuta, diagnosticar ni reemplazar apoyo profesional. KAIRON no es terapia. Es coaching cognitivo-conductual aplicado a ejecución, y esa frontera debe estar clara dentro del producto, no solo en los textos legales." },
      { type: "p", text: "Ahora estamos preparando una prueba inicial con un grupo pequeño de testers. No buscamos una validación superficial ni una ronda de comentarios amables. Buscamos fricción real. Queremos observar si las personas entienden qué es KAIRON en los primeros minutos, si saben por dónde empezar, si el Calibrador les entrega una lectura útil, si Quick Reframe funciona en un bloqueo real y si Restructure Lab se siente suficientemente profundo sin volverse pesado." },
      ...
      { type: "quote", text: "KAIRON no quiere ayudar a las personas simplemente a hacer más. Quiere ayudarles a entender qué patrón está elevando el costo de actuar." },
      ...
      { type: "p", text: "En las próximas semanas estaremos probando, ajustando y reconstruyendo partes del prototipo con una obsesión concreta: que abrir KAIRON se sienta como entrar a una ruta clara para desbloquearte, no como otra app que tienes que descifrar." },
...
export const EN_ARTICLES: Article[] = [
  {
    ...
    title: "G-Structure advances as a CodeLaunch LATAM 2026 semifinalist",
    subtitle: "A new traction signal for G-Structure and KAIRON from Ecuador.",
    category: "Company Updates",
    excerpt:
      "G-Structure is a CodeLaunch LATAM 2026 semifinalist. We are waiting to see whether we will be selected to compete in the Guadalajara finals; if we win that stage, we could advance to the World Championship in Dallas.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-27",
    readMinutes: 4,
    featured: true,
    tags: ["G-Structure", "CodeLaunch LATAM 2026", "KAIRON", "Startup"],
    blocks: [
      { type: "p", text: "Today we received a major piece of news for G-Structure: we advanced as semifinalists in CodeLaunch LATAM 2026." },
      ...
      { type: "p", text: "That product is KAIRON. The 1:1 programs, Enterprise channel, Execution Diagnostic Workshop, and early support are not separate businesses; they are validation channels for the I-R-O™ Method, a way to learn with real users, generate early revenue, and prepare the path toward a scalable digital product." },
      { type: "p", text: "Being at this stage of CodeLaunch LATAM pushes us to keep tightening the fundamentals: product, narrative, validation, team, evidence, and traction. We are now waiting to see whether we will be selected to compete in the regional finals in Guadalajara, Mexico, on October 14, 2026. If we win that stage, we could advance to the World Championship in Dallas, Texas, on November 12, 2026." },
      { type: "quote", text: "G-Structure is building KAIRON from Ecuador, with regional ambition and a clear thesis about human execution." },
      { type: "p", text: "Before we get there, there is work to do: continue developing the prototype, strengthen user validation, prepare the launch inside Ecuador Tech Week 2026, and show that KAIRON can address a real gap: the distance between knowing what to do and being able to execute it." },
      { type: "p", text: "This news does not change the direction. It confirms it. G-Structure remains the startup. KAIRON remains the main product. I-R-O™ remains the method behind the build. And now we have a new platform to take that vision further." },
  ...
  },
  {
    ...
    subtitle: "Our public brand remains G-Structure. Our main product remains KAIRON. SUCOSTRUCT S.A.S. B.I.C. is the legal structure behind the next stage.",
    category: "Company Updates",
    excerpt:
      "G-Structure now has a formal legal structure in Ecuador as SUCOSTRUCT S.A.S. B.I.C., giving the startup a clearer base to operate, validate, and scale KAIRON.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-21",
    readMinutes: 4,
    featured: true,
    ...
    blocks: [
      ...
      { type: "p", text: "G-Structure now has a formal legal structure in Ecuador: SUCOSTRUCT S.A.S. B.I.C. This is not a brand change. G-Structure remains our commercial name, our public identity, and the space from which we continue building our methodology, our validation programs, and our main product: KAIRON." },
      ...
      { type: "p", text: "This structure helps us organize operations, open corporate conversations with more solidity, prepare the development of KAIRON as a digital platform, and build commercial, institutional, and strategic relationships from an appropriate legal figure." },
      { type: "p", text: "KAIRON remains a central priority. This incorporation gives us a stronger base to keep working on its development, validation, and scaling. We are not only talking about an app. We are building a tool to help people process mental friction, understand their execution patterns, and turn clarity into action." },
      ...
      { type: "p", text: "This step confirms something important: we are building the structure required to sustain our vision. We want to consolidate G-Structure as a leading startup in the region for professional execution optimization, turning our proprietary I-R-O™ method into a digital standard for cognitive-behavioral development through the scaling of KAIRON." },
      { type: "p", text: "G-Structure remains G-Structure. KAIRON remains the main product. We now operate from a clearer legal structure: SUCOSTRUCT S.A.S. B.I.C." },
      { type: "p", text: "And we keep moving forward." },
    ],
  },
  {
    slug: "g-frame-product-update-q3",
    title: "KAIRON Product Update: what we are building for Q3",
    category: "KAIRON Build Notes",
    excerpt:
      "A look at the KAIRON prototype, the I-R-O™ logic behind it, and what we are validating before the Q3 launch.",
    author: "Guillermo Suco",
    publishedAt: "2026-05-19",
    readMinutes: 7,
    featured: true,
    tags: ["KAIRON", "Product Update", "Q3", "Execution"],
    blocks: [
      { type: "p", text: "One question has guided KAIRON from the beginning: what if an app did not only help people organize tasks, but helped them understand the mental pattern that keeps those tasks from being executed?" },
      { type: "p", text: "That question still drives the product. We are not building another productivity app. We are not building a journaling app, a mood tracker, or a daily motivation tool. KAIRON starts from a different premise: many people do not get blocked because they do not know what to do, but because the mental cost of doing it becomes too high." },
      ...
      { type: "p", text: "On top of that structure we are integrating an AI layer: Guillermo, the virtual coach inside KAIRON. This requires special care. AI cannot be decoration, and it cannot be a generic voice that gives correct but empty phrases. It has to understand the method, respect safety boundaries, use clear language, and help the user move from thought to action. It also cannot present itself as a therapist, diagnose, or replace professional support. KAIRON is not therapy. It is cognitive-behavioral coaching applied to execution, and that boundary has to be clear inside the product, not only in legal copy." },
      { type: "p", text: "We are now preparing an initial test with a small group of users. We are not looking for superficial validation or a round of polite comments. We are looking for real friction. We want to see whether people understand what KAIRON is in the first few minutes, whether they know where to start, whether the Calibrator gives them a useful reading, whether Quick Reframe works in a real block, and whether Restructure Lab feels deep enough without becoming heavy." },
      ...
      { type: "quote", text: "KAIRON does not want to help people simply do more. It wants to help them understand what pattern is raising the cost of action." },
