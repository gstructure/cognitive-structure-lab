...
export const Route = createFileRoute("/en/articles/")({
  head: () => ({
    meta: buildSeo({
      ...
      description:
        "Articles, founder notes, and product updates about KAIRON, the I-R-O™ method, and cognitive-behavioral execution.",
      locale: "en_US",
    }),
    links: [
    ...
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
              This section gathers the thinking behind KAIRON: product notes, essays on the I-R-O™ method, and build-stage learnings.
            </p>
          </div>
      ...
      <Section>
        <SectionHeader
          eyebrow="ARCHIVE"
          title="All articles"
          subtitle="An initial library for users and investors to understand the intellectual core of KAIRON."
        />
