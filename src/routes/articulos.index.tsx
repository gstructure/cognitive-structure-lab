...
export const Route = createFileRoute("/articulos/")({
  head: () => ({
    meta: buildSeo({
      ...
      description:
        "Artículos, founder notes y updates sobre KAIRON, el método I-R-O™ y la ejecución cognitivo-conductual.",
    }),
    links: [
    ...
    <>
        ...
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
              Esta sección concentra el pensamiento detrás de KAIRON: notas de producto, ensayos del método I-R-O™ y aprendizajes de construcción.
            </p>
          </div>
      ...
      <Section>
        <SectionHeader
          ...
          subtitle="Una biblioteca inicial para que usuarios e inversionistas entiendan el corazón intelectual de KAIRON."
        />
