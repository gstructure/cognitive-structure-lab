...
const COPY = {
  es: {
    ...
    body: "Un documento breve, sobrio y directo para conocer KAIRON, el método I-R-O™ y los canales de validación que alimentan el producto. Pensado para empresas, aliados, sponsors y potenciales colaboradores.",
    bullets: [
  ...
  en: {
    ...
    body: "A short, sober, and direct document covering KAIRON, the I-R-O™ Method, and the validation channels that feed the product. Designed for companies, partners, sponsors, and potential collaborators.",
    bullets: [
      "· 8 pages · A4 vertical",
