      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
              Personas que apoyaron económicamente la validación de KAIRON. Usa esta lista para
        ...
        <div className="mt-6 border border-border bg-card p-5 text-sm leading-relaxed text-muted-foreground">
          ...
          <p className="mt-2">
            ...
            supporters: avances de KAIRON, uso general de fondos, aprendizajes de validación,
            estado del workshop, mejora del MVP activo y próximos hitos. No los mezcles con marketing
