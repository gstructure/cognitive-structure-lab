...
const AREAS = [
  { t: "Product", d: "Design and definition of features for KAIRON, user research, and hypothesis validation." },
  { t: "Technology", d: "Development, prototyping, and architecture of the KAIRON app, alongside the ÉPICO technical team." },
  { t: "Sales", d: "B2B conversations with companies, founders, and teams to present Workshop, RESTRUCTURE Enterprise, and Continuity." },
  { t: "Marketing", d: "Brand strategy, editorial content, digital communication, and positioning of G-Structure and KAIRON." },
...
export const Route = createFileRoute("/en/join-the-team")({
  head: () => ({
    meta: buildSeo({
      ...
      title: "Join the Team | G-Structure & KAIRON",
      description:
