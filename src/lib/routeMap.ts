...
export const ROUTES: RouteEntry[] = [
  ...
  { es: "/legal/terminos-y-condiciones", en: "/en/legal/terms-and-conditions", label: { es: "Términos y Condiciones", en: "Terms and Conditions" } },
  { es: "/legal/politica-de-privacidad", en: "/en/legal/privacy-policy", label: { es: "Política de Privacidad", en: "Privacy Policy" } },
  { es: "/legal/politica-de-reembolsos", en: "/en/legal/refund-policy", label: { es: "Política de Reembolsos", en: "Refund Policy" } },
