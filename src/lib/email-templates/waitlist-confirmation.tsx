...
const SITE_NAME = "KAIRON";

const Email = () => (
  <Html lang="es" dir="ltr">
    <Head />
    <Preview>Estás en la lista — KAIRON te avisa cuando esté listo</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={signature}>— Guillermo Suco<br />Fundador, KAIRON</Text>
        <Hr style={hr} />
...
export const template = {
  component: Email,
  subject: "Estás en la lista — KAIRON te avisa cuando esté listo",
