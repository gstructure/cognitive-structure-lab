...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "p", text: "Sabemos que la realidad tiene una dimensión objetiva. Una cama es una cama aquí y en cualquier parte del mundo. Un plato de comida sigue siendo un plato de comida aquí o en la China. Cambiarán los ingredientes, la sazón, la forma de prepararlo, incluso el valor cultural que se le atribuye. Pero, en términos materiales, sigue siendo comida: una fuente de nutrientes, vitaminas, proteínas, minerales y todo aquello que el cuerpo necesita para sostenerse." },
      ...
      { type: "p", text: "Las respuestas serán distintas si el olor, sonido o evento en el que te encuentras activa memorias tristes, dolorosas o desafiantes. La interpretación será completamente distinta. Catalogaríamos nuestro evento como malo, injusto o humillante, y esa interpretación generará de forma inmediata, casi intrusiva, un pensamiento. Ese pensamiento se conoce como pensamiento automático." },
