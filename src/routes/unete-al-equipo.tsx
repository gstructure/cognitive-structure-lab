...
export const Route = createFileRoute("/unete-al-equipo")({
  head: () => ({
    meta: buildSeo({
      ...
      title: "Únete al Equipo | G-Structure & KAIRON",
      description:
...
const AREAS = [
  { t: "Producto", d: "Diseño y definición de funcionalidades para KAIRON, investigación con usuarios y validación de hipótesis." },
  { t: "Tecnología", d: "Desarrollo, prototipado y arquitectura de la app KAIRON, junto al equipo técnico de ÉPICO." },
  ...
  { t: "Marketing", d: "Estrategia de marca, contenido editorial, comunicación digital y posicionamiento de G-Structure y KAIRON." },
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="container-x relative py-20 md:py-28 lg:py-32">
          ...
          <h1 className="mt-6 max-w-4xl font-display text-4xl md:text-5xl lg:text-[3.25rem] leading-[1.05]">
            Estamos formando el equipo que construirá G-Structure y KAIRON.
          </h1>
